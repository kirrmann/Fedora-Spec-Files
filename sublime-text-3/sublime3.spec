...
Source0:       http://c758482.r82.cf2.rackcdn.com/%{name}_%{version}_build_%{rel}_%{_arch}.tar.bz2
...
%{__cp} -aR ./Sublime\ Text\ 3/* %{buildroot}/usr/local/%{name}/
...
%changelog
* Tue Mar 01 2013 Stefan Kirrmann <stefan.kirrmann@gmail.com> - 3006
- Sublime Text 3 Beta
